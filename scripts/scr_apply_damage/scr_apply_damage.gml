...
/// @param {id} target_instance The instance to apply damage to.
/// @param {real} damage_amount The amount of damage to apply.
/// @param {string} health_variable_name A string for the health variable name (e.g., "player_health", "enemy_health").
/// @param {sound} damage_sound sound to play when damage is taken.
...
function scr_apply_damage(target_instance, damage_amount, health_variable_name, damage_sound) {
    ...
    if (variable_instance_exists(target_instance, health_variable_name)) {
        ...
        // Apply damage: Update the health variable to it's new value
