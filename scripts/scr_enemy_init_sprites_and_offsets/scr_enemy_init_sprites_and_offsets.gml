/// @function scr_enemy_init_sprites_and_offsets(_idle_sprite, _patrol_move_sprite, _chase_move_sprite, _taunt_sprite, _attack_sprite)
...
/// @arg {sprite_index} _attack_sprite         The specific attack sprite for this enemy type.
...
function scr_enemy_init_sprites_and_offsets(_idle_sprite, _patrol_move_sprite, _chase_move_sprite, _taunt_sprite, _attack_sprite) {
    ...
    self.spr_taunt_specific = _taunt_sprite; // Store the specific taunt sprite
    self.spr_attack_specific = _attack_sprite; // NEW: Store the specific attack sprite
