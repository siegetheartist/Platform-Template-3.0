...
/// @param {real} [duration=12] The duration of the flash in frames.
/// @param {colour} [color=c_white] The color of the flash.

function scr_obj_flash_initialize(_object = id, _duration = 12, _color = c_white) {
...
// TODO: Rework this. Why is this script holding it's own flash timer when the player already does it?
...
function scr_obj_flash_draw() {
    ...
    if (flash_timer > 0) {
        ...
        // This gives you a 3‑on, 3‑off flicker - "blinking" effect
